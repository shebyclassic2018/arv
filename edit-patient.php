<?php
    ...
    $uid = $_GET['user_id'];
    $select = $conn->query("SELECT * FROM user u, email e, phone p, address a WHERE u.id = a.user_id AND u.id = e.user_id AND u.id = p.user_id AND u.id = '$uid'");
...
<main id="main-container" style="background: #333">
    ...
    <div class="bg-body-black">
        <div class="content content-full">
            <div class="content-heading">EDIT PATIENT</div>
        </div>
    </div>
